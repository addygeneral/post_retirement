												...
												<div class="profile-timeline">
													...
													<div class="profile-timeline-list">
														<ul>
															...
															<li>
																<div class="date"><?php echo $row['num_days']; ?> Years</div>
													...
													<div class="profile-edit-list row">
														...
														<div class="col-md-6 col-sm-12">
															<div class="form-group">
																...
																<select name="rank" class="custom-select form-control" required="true" autocomplete="off" value="<?php echo $row['Rank']; ?>">
														...
														<div class="weight-500 col-md-6">
															...
															?>
															<div class="form-group">
																<label>Available Post Retirement Years</label>
