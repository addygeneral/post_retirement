			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						...
						$sql = "SELECT tblpostretirements.id as lid,tblemployees.Rank,tblemployees.FirstName,tblemployees.LastName,tblemployees.emp_id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,tblemployees.Av_postretirement,tblpostretirements.PostretirementType,tblpostretirements.FromDate,tblpostretirements.ToDate,tblpostretirements.Description,tblpostretirements.File,tblpostretirements.PostingDate,tblpostretirements.Status,tblpostretirements.AdminRemark,tblpostretirements.admin_status,tblpostretirements.registra_remarks,tblpostretirements.AdminRemarkDate,tblpostretirements.num_days from tblpostretirements join tblemployees on tblpostretirements.empid=tblemployees.emp_id where tblpostretirements.id=:lid";
						...
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo htmlentities($result->Rank." ".$result->FirstName." ".$result->LastName);?>">
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly value="<?php echo htmlentities($result->Av_postretirement);?>">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Status From Registrar</b></label>
