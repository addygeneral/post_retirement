	...
	<div class="main-container">
		<div class="pd-ltr-20">
			<div class="title pb-20">
				<h2 class="h3 mb-0">Post Retirement Breakdown</h2>
			</div>
			<div class="row pb-10">
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$sql = "SELECT id from tblpostretirements";
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">All Applied Post Retirement</div>
							</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=1;
						 $query = mysqli_query($conn,"select * from tblpostretirements where empid = '$session_id' AND Status = '$status'")or die( );
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=0;
						 $query_pend = mysqli_query($conn,"select * from tblpostretirements where empid = '$session_id' AND Status = '$status'")or die( );
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=2;
						 $query_reject = mysqli_query($conn,"select * from tblpostretirements where empid = '$session_id' AND Status = '$status'")or die( );
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">ALL MY POST RETIREMENT</h2>
					</div>
				<div class="pb-20">
                                  ...
                                  <td><?php $stats=$result->Status;
								   ...
								   <td>
									  <div class="table-actions">
										<a title="VIEW" href="view_postretirement.php?edit=<?php echo htmlentities($result->id);?>" data-color="#265ed7"><i class="icon-copy dw dw-eye">View</i></a>
									  </div>
								   </td>
							</tr>
							<?php $cnt++;} }?>  
