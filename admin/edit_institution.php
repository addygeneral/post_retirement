 ...
 if(isset($_POST['edit']))
{
    ...
    $result = mysqli_query($conn,"update tblinstitutions set InstitutionName = '$deptname' , InstitutionShortName ='$deptshortname' where id = '$get_id' ");
    if ($result) {
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">Edit Institution</h2>
								<section>
									<?php
									$query = mysqli_query($conn,"SELECT * from tblinstitutions where id = '$get_id'")or die();
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name=institutiontname" type="text" class="form-control" required="true" autocomplete="off" value="<?php echo $row['InstitutionName']; ?>">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name="institutionshortname" type="text" class="form-control" required="true" autocomplete="off" style="text-transform:uppercase" value="<?php echo $row['InstitutionShortName']; ?>">
											</div>
										</div>
									</div>
									...
									<table class="data-table table stripe hover nowrap">
										...
										<tbody>
											...
											<tr>
	                                            ...
	                                            <td><?php echo htmlentities($result->InstitutiontName);?></td>
