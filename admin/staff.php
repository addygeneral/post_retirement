					...
					<table class="data-table table stripe hover">
						...
						<tbody>
							<tr>
								 ...
								 <?php
		                         $teacher_query = mysqli_query($conn,"select * from tblemployees LEFT JOIN tblinstitutions ON tblemployees.Institution = tblinstitutions.InstitutionShortName where role != 'Admin' ORDER BY tblemployees.emp_id") or die( );
