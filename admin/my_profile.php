...
if(isset($_POST['new_update']))
{
    ...
    $result = mysqli_query($conn,"update tblemployees set FirstName='$fname', LastName='$lname', Age='$age', EmailId='$email', Gender='$gender', Dob='$dob', Rank='$rank', Institution='$institution', Address='$address', Phonenumber='$phonenumber' where emp_id='$session_id'         
		")or die( );
    if ($result) {
												...
												<form method="POST" enctype="multipart/form-data">
													<div class="profile-edit-list row">
														...
														<div class="col-md-4 col-sm-12">
															<div class="form-group">
																<label>Age :</label>
																<input name="age" type="text" class="form-control" placeholder="" readonly required="true" autocomplete="off" value="<?php echo $row['Age']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
