					...
					<table class="data-table table stripe hover">
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="dropdown">
										<a class="btn btn-link font-10 p-0 line-height-1 no-arrow dropdown-toggle" href="#" role="button" data-toggle="dropdown">
											<i class="dw dw-more">Act</i>
										</a>
