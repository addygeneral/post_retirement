...
<?php
	...
	{ 
		...
		$reg_remarks = 'Post Retirement was Not Approved. Registrar will not see it';
		$reg_status = 2;
		date_default_timezone_set('Asia/Kolkata');
		$admremarkdate=date('Y-m-d G:i:s ', strtotime("now"));

		if ($status === '2') {
			$result = mysqli_query($conn,"update tblpostretirements, tblemployees set tblpostretirements.AdminRemark='$description',tblpostretirements.Status='$status',tblpostretirements.AdminRemarkDate='$admremarkdate', tblpostretirements.registra_remarks = '$reg_remarks', tblpostretirements.admin_status = '$reg_status' where tblpostretirements.empid = tblemployees.emp_id AND tblpostretirements.id='$did'");
		...
		elseif ($status === '1') {
				$result = mysqli_query($conn,"update tblpostretirements, tblemployees set tblpostretirements.AdminRemark='$description',tblpostretirements.Status='$status',tblpostretirements.AdminRemarkDate='$admremarkdate' where tblpostretirements.empid = tblemployees.emp_id AND tblpostretirements.id='$did'");
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Date of Application</b></label>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label style="font-size:16px;"><b>GTEC Status</b></label>
									...
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											<div class="modal-body text-center font-18">
												<h4 class="mb-20">Post Retirement take action</h4>
