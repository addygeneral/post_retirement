...
<?php
	...
	$result = mysqli_query($conn,"update tblemployees set FirstName='$fname', LastName='$lname', Rank='$rank', EmailId='$email', Gender='$gender', Dob='$dob', Institution='$institution', Address='$address', Age='$age', Av_postretirement='$postretirement_days', role='$user_role', Phonenumber='$phonenumber' where emp_id='$get_id'         
		"); 		
	if ($result) {
