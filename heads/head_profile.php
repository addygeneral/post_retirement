...
if(isset($_POST['new_update']))
{
    ...
    $result = mysqli_query($conn,"update tblemployees set FirstName='$fname', LastName='$lname', Rank='$rank', EmailId='$email', Gender='$gender', Dob='$dob', Institution='$institution', Address='$address', Age='$age',  Phonenumber='$phonenumber' where emp_id='$session_id'         
		")or die( );
    if ($result) {
				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<?php $query= mysqli_query($conn,"select * from tblemployees LEFT JOIN tblinstitutions ON tblemployees.Institution = tblinstitutions.InstitutionShortName where emp_id = '$session_id'")or die( );
							...
							<p class="text-center text-muted font-14"><?php echo $row['InstitutionName']; ?></p>
							<div class="profile-info">
								...
								<ul>
									...
									<li>
										...
										<? $roles = $row['role']; ?>
										<?php if($roles = 'REG'): ?>
										 <?php echo "Registrar of Institution"; ?>
										<?php endif ?>
									</li>
									<li>
										<span>Address:</span>
							...
							<div class="profile-tab height-100-p">
								<div class="tab height-100-p">
									<ul class="nav nav-tabs customtab" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">Post Retirement Records</a>
										</li>
										<li class="nav-item">
										...
										<div class="tab-pane fade show active" id="timeline" role="tabpanel">
											<div class="pd-20">
												<div class="profile-timeline">
													<?php $query= mysqli_query($conn,"SELECT * from tblpostretirements where empid = '$session_id'")or die( );
													...
													<div class="profile-timeline-list">
														<ul>
															...
															<li>
																...
																<div class="task-name"><i class="ion-ios-chatboxes"></i><?php echo $row['PostretirementType']; ?></div>
												...
												<form method="POST" enctype="multipart/form-data">
													<div class="profile-edit-list row">
														...
														<div class="col-md-4 col-sm-12">
															<div class="form-group">
																<label>Age :</label>
																<input name="age" type="text" class="form-control" readonly required="true" autocomplete="off" value="<?php echo $row['Age']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<select name="institution" class="custom-select form-control" required="true" autocomplete="off">
																	<?php
																		$query_staff = mysqli_query($conn,"select * from tblemployees join  tblinstitutions where emp_id = '$session_id'")or die( );
																		$row_staff = mysqli_fetch_array($query_staff);
																		
																	 ?>
																	<option value="<?php echo $row_staff['InstitutionShortName']; ?>"><?php echo $row_staff['InstitutionName']; ?></option>
																		<?php
														...
														<div class="weight-500 col-md-6">
															...
															?>
															<div class="form-group">
																<label>Available Postretirement Years</label>
																<input class="form-control form-control-lg" type="text" required="true" autocomplete="off" readonly value="<?php echo $row['Av_postretirement']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
