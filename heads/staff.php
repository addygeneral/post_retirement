			...
			<div class="row pb-10">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_hod = mysqli_query($conn,"select * from tblemployees where role = 'REG' ")or die( );
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Institutional Regs</div>
							</div>
							<div class="widget-icon">
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								 ...
								 <?php
		                         $teacher_query = mysqli_query($conn,"select * from tblemployees LEFT JOIN tblinstitutions ON tblemployees.Institution = tblinstitutions.InstitutionShortName where tblemployees.role = 'Staff' and tblemployees.Institution = '$session_depart' ORDER BY tblemployees.emp_id") or die( );
								...
								<td><?php echo $row['Av_postretirement']; ?></td>
								<td>
									<div class="dropdown">
